...
class ExtensionManager {
	...
	public function __construct() {
		...
		// Load configuration
		$this->settings = \TYPO3\CMS\Vidi\Utility\Setting::getInstance()->getSettings();
	...
	public function renderMessage(&$params, &$tsObj) {
		...
		if ($this->needsUpdate()) {
			...
			<div style="">
				<div class="typo3-message message-warning">
					<div class="message-header">'
						. $GLOBALS['LANG']->sL('LLL:EXT:vidi/Resources/Private/Language/locallang_extension_manager.xlf:updater_header') .
					'</div>
					<div class="message-body">
						' . $GLOBALS['LANG']->sL('LLL:EXT:vidi/Resources/Private/Language/locallang_extension_manager.xlf:updater_message') . '
					</div>
				</div>
			</div>
			';
			...
			<div style="">
				<div class="typo3-message message-ok">
					<div class="message-header">'
						. $GLOBALS['LANG']->sL('LLL:EXT:vidi/Resources/Private/Language/locallang_extension_manager.xlf:ok_header') .
					'</div>
					<div class="message-body">
						' . $GLOBALS['LANG']->sL('LLL:EXT:vidi/Resources/Private/Language/locallang_extension_manager.xlf:ok_message') . '
					</div>
				</div>
			</div>
			';

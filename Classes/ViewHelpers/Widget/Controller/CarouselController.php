<?php
namespace TYPO3\CMS\Vidi\ViewHelpers\Widget\Controller;
...
class CarouselController extends \TYPO3\CMS\Fluid\Core\Widget\AbstractWidgetController {
	...
	/**
	 * @var \TYPO3\CMS\Vidi\Domain\Repository\ImageRepository
	 * @inject
	 */
	...
	public function indexAction() {
		...
		$order = NULL;
		if ($this->sort) {
			/** @var $order \TYPO3\CMS\Vidi\QueryElement\Order */
			$order = $this->objectManager->get('TYPO3\CMS\Vidi\QueryElement\Order');
			$order->addOrdering($this->sort, $this->order);
		}

		/** @var $matcher \TYPO3\CMS\Vidi\QueryElement\Matcher */
		$matcher = $this->objectManager->get('TYPO3\CMS\Vidi\QueryElement\Matcher');

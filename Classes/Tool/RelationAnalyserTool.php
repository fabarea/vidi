...
class RelationAnalyserTool extends AbstractTool {
	...
	public function getDescription() {
		$templateNameAndPath = 'EXT:vidi/Resources/Private/Backend/StandAlone/Tool/AnalyseRelations/Welcome.html';
	...
	public function work(array $arguments = array()) {
		...
		$templateNameAndPath = 'EXT:vidi/Resources/Private/Backend/StandAlone/Tool/AnalyseRelations/Work.html';
		$view = $this->initializeStandaloneView($templateNameAndPath);

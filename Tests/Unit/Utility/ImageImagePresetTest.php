...
/**
 * Test case for class \TYPO3\CMS\Vidi\Utility\SettingImagePreset.
 */
class SettingImagePresetTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \TYPO3\CMS\Vidi\Utility\SettingImagePreset
	 */
	private $fixture;

	public function setUp() {
		$this->fixture = new \TYPO3\CMS\Vidi\Utility\SettingImagePreset();
	}
	...
	/**
	 * @test
	 * @expectedException \TYPO3\CMS\Vidi\Exception\EmptyValueException
	 */
	...
	public function methodPresetReturnInstanceOfSettingImagePreset() {
		...
		$this->assertTrue($object instanceof \TYPO3\CMS\Vidi\Utility\SettingImagePreset);
	}
	...
	public function testProperty($preset, $setting, $width, $height) {
		\TYPO3\CMS\Vidi\Utility\Setting::getInstance()->set($preset, $setting);
	...
	public function setOriginalImageAsPresetWithValue0AndCheckWidthEquals0() {
		...
		\TYPO3\CMS\Vidi\Utility\Setting::getInstance()->set('image_original', 0);
	...
	public function setOriginalImageAsPresetWithRandomValueAndCheckWidthAndHeightCorrespondsToThisRandomValue() {
		...
		\TYPO3\CMS\Vidi\Utility\Setting::getInstance()->set('image_original', $actualWidth . 'x' . $actualHeight);

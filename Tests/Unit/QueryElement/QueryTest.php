...
/**
 * Test case for class \TYPO3\CMS\Vidi\QueryElement\Query.
 */
class QueryTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \TYPO3\CMS\Vidi\QueryElement\Query
	 */
	private $fixture;
	...
	public function getterAndSetterForOrderPropertyAreOK() {
		$ordering = new \TYPO3\CMS\Vidi\QueryElement\Order();
		$this->fixture->setOrder($ordering);
		$object = $this->fixture->getOrder();
		$this->assertTrue($object instanceof \TYPO3\CMS\Vidi\QueryElement\Order);
	}
	...
	public function testProperty($propertyName, $value) {
		...
		$this->assertTrue($actual instanceof \TYPO3\CMS\Vidi\QueryElement\Query);

...
/**
 * Test case for class \TYPO3\CMS\Vidi\Domain\Repository\AssetRepository.
 */
class ContentRepositoryTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @var \TYPO3\CMS\Vidi\Domain\Repository\AssetRepository
	 */
	private $fixture;

	public function setUp() {
		$this->testingFramework = new \Tx_Phpunit_Framework('sys_file');
		$this->fixture = new \TYPO3\CMS\Vidi\Domain\Repository\AssetRepository();
		...
		// Disable permission
		\TYPO3\CMS\Vidi\Utility\Setting::getInstance()->set('permission', FALSE);
	}
	...
	/**
	 * @test
	 * @expectedException \TYPO3\CMS\Vidi\Exception\MissingUidException
	 */
	...
	public function findByReturnsSameNumberOfRecordsAsNumberOfFakeRecords() {
		$matcher = new \TYPO3\CMS\Vidi\QueryElement\Matcher();
	...
	public function findByUidCanReturnTheLastInsertedMedia() {
		...
		$this->assertTrue($actual instanceof \TYPO3\CMS\Vidi\Domain\Model\Content);
	}
	...
	public function methodGetFileMethodReturnsValueZeroForFileObjectFoo() {
		...
		$method = new \ReflectionMethod(
			'TYPO3\CMS\Vidi\Domain\Repository\AssetRepository', 'getFileType'
		);
	...
	public function methodGetFileMethodReturnsValueTwoForFileObjectImage() {
		...
		$expected = 2;
		$this->assertSame($expected, $method->invokeArgs($this->fixture, array('TYPO3\CMS\Vidi\Domain\Model\Image')));
	}
		...
		for ($index = 0; $index < $this->numberOfFakeRecords; $index++) {
			...
			$this->lastInsertedUid = $this->testingFramework->createRecord(
				...
				array(
					...
					'storage' => \TYPO3\CMS\Vidi\Utility\Setting::getInstance()->get('storage'),
